 ...
 *
 * Drawn here rather than fetched, because a sign-in button that waits on a
 * third-party CDN is a sign-in button that sometimes renders empty - and
 * loading a remote asset on the login page would leak that a visitor is
 * looking at it. Both marks are the vendors' published paths.
 *
 * Google's is deliberately multi-coloured, which is its brand requirement;
 * GitHub's takes `currentColor` so it inverts correctly in the dark theme.
 */
